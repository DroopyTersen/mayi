...
| **May I**        | `mayI()`      | Claim the top discard out of turn                            |
...
- **May I**: Can be called by any player when it’s not their turn. Player receives the discard + 1 penalty card from stock. Priority goes to player closest in turn order.
